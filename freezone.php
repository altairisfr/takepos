...
<?php
if ($action == "freezone") {
	echo '<input type="text" id="number" name="number" class="takepospay" style="width:15%;" placeholder="'.$langs->trans($conf->global->TAKEPOS_CHANGE_PRICE_HT ? 'AmountHT' : 'AmountTTC').'">';
}
if ($action == "addnote") {
